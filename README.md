...
Tinyml With Wio Terminal is a hands-on course focused on practical Embedded Systems
...
- Understand the core goals of the **Tinyml With Wio Terminal** lessons.
...
sensors/actuators described in the Tinyml With Wio Terminal videos, jumper wires, and a
...
# Or upload via Arduino IDE to replicate the Tinyml With Wio Terminal lab
```
